...
export function ObjectivesTable({ objectives, onDelete, onEdit }: ObjectivesTableProps) {
  ...
  // Sort objectives by end date (ascending, so closest end date first)
      ...
      <table className="min-w-full divide-y divide-border">
        ...
        <tbody className="bg-background divide-y divide-border">
          {sortedObjectives.map((objective) => {
            // Filter key results that aren't deleted
            const activeKeyResults = objective.keyResults.filter(kr => !kr.deleted);
            ...
            return (
              <React.Fragment key={objective.id}>
                ...
                {activeKeyResults.map((keyResult) => {
                  // Get initiatives that belong to this key result
                  ...
                  return (
                    <React.Fragment key={keyResult.id}>
                      ...
                      {/* Render initiatives that belong to this key result */}
                ...
                {/* Initiatives that don't belong to any key result */}
